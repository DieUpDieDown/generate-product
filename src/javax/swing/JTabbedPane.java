...
public class JTabbedPane extends JComponent implements Serializable,
	...
	protected class ModelListener implements ChangeListener, Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 7806230337180987192L;
	 ...
	 *                if index is out of range (index < -1 || index >= tab
	 *                count)
	 * 
	...
	public Icon getDisabledIconAt(int index) {
		...
		if (page.disabledIcon == null) {
			page.disabledIcon = UIManager.getLookAndFeel().getDisabledIcon(
					this, page.icon);
		}
	...
	public void setComponentAt(int index, Component component) {
		...
		if (component != page.component) {
			...
			if (page.component != null) {
				shouldChangeFocus = (SwingUtilities
						.findFocusOwner(page.component) != null);
	...
	public String getToolTipText(MouseEvent event) {
		if (ui != null) {
			int index = ((TabbedPaneUI) ui).tabForCoordinate(this,
	...
	protected class AccessibleJTabbedPane extends AccessibleJComponent
		 ...
		 * 
		 */
		private static final long serialVersionUID = 7253887794605323396L;
	...
	public class Page extends AccessibleContext implements Serializable,
			Accessible, AccessibleComponent {
		/**
		 * 
		 */
		private static final long serialVersionUID = -6235027150884385332L;
		String title;
		Color background;
		Color foreground;
		Icon icon;
		...
		void setDisplayedMnemonicIndex(int mnemonicIndex) {
			if (this.mnemonicIndex != mnemonicIndex) {
				if (mnemonicIndex != -1
						&& (title == null || mnemonicIndex < 0 || mnemonicIndex >= title
								.length())) {
					throw new IllegalArgumentException(
		...
		void updateDisplayedMnemonicIndex() {
			setDisplayedMnemonicIndex(SwingUtilities
					.findDisplayedMnemonicIndex(title, mnemonic));
		}
		...
		public Rectangle getBounds() {
			return parent.getUI()
					.getTabBounds(parent, parent.indexOfTab(title));
		}
		...
		public boolean isNeedsUIUpdate() {
			return needsUIUpdate;
		}

		public void setNeedsUIUpdate(boolean needsUIUpdate) {
			this.needsUIUpdate = needsUIUpdate;
		}
	...
	public void hideComponent(Component component) {
		for (Page page:pages){
			if (page.component.equals(component)){
